					...
					<div class="tg-footerinfo">
						...
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
							<div class="tg-widget tg-widgettext">
								<div class="tg-widgetcontent">
									<strong class="tg-logo"><a href="javascript:void(0);"><img src="{{asset('front/UserDashboard/assets/images/logof.png')}}" alt="image description"></a></strong>
									...
									<div class="tg-followus">
										...
										<ul class="tg-appsnav">
											<li><a href="javascript:void(0);"><img  src="{{asset('front/UserDashboard/assets/images/apps-01.png')}}" alt="image description"></a></li>
											<li><a href="javascript:void(0);"><img src="{{asset('front/UserDashboard/assets/images/apps-02.png')}}" alt="image description"></a></li>
										</ul>
									</div>
