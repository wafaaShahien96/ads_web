    ...
    <div class="card card-custom">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{ route('admin.country.create') }}" class="btn btn-primary font-weight-bolder">
                <i class="la la-plus"></i>@lang('trans.countries.fields.add_country')
            </a>
            {{-- @endcan --}}
            <!--end::Button-->
        </div>
         ...
         <div class="card-body">
            <table class="table table-hover" id=" example">
                <thead>
                    <tr>
                    <th scope="col">#</th>
                    <th scope="col">@lang('trans.countries.fields.name')</th>
                ...
                <tbody>
                    ...
                    <td>{{$country->name}}</td>
                    <td>
                        <a href="{{ route('admin.country.edit', $country->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                        <form class="delete_form d-inline-block" action="{{route('admin.country.destroy', $country->id)}} " method="post">
                            @csrf
                            {{ method_field('DELETE') }}
