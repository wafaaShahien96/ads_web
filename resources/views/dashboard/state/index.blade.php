    ...
    <div class="card card-custom">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{ route('admin.state.create') }}" class="btn btn-primary font-weight-bolder">
                <i class="la la-plus"></i>@lang('trans.states.fields.add_state')
            </a>
            {{-- @endcan --}}
            <!--end::Button-->
        </div>
         ...
         <div class="card-body">
            <table class="table table-hover" id=" example">
                <thead>
                    <tr>
                    <th scope="col">#</th>
                    <th scope="col">@lang('trans.states.fields.country_id')</th>
                    <th scope="col">@lang('trans.states.fields.name')</th>
                ...
                <tbody>
                    ...
                    <td>{{$state->name}}</td>
                    <td>
                        <a href="{{ route('admin.state.edit', $state->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                        <form class="delete_form d-inline-block" action="{{route('admin.state.destroy', $state->id)}}" method="post">
                            @csrf
                            {{ method_field('DELETE') }}
