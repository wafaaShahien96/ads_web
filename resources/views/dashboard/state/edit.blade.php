        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    @lang('trans.states.fields.edit_state')
                </h3>
    ...
    <div class="container-fluid">
        <div class="card" style="margin-top: -80px">
            <div class="card-header">
                <h3>@lang('trans.states.fields.edit_state')</h3>
            </div>
            <div class="card-body">
                <form action="{{route('admin.state.update' ,$state->id)}}" method="post">
                    ...
                    <option value="{{$country->id}}"
                            @if ($state->country_id == $country->id) selected
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name:en" id="name_en" class="form-control" value="{{$state->translate('en')->name}}" >
                        @error('name:en')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name:ar" id="name_ar" class="form-control" value="{{$state->translate('ar')->name}}" >
                        @error('name:ar')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
