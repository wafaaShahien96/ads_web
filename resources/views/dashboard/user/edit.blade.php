        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    ...
                    @lang('trans.users.fields.edit_user')
                </h3>
    ...
    <div class="container-fluid">
        <div class="card" style="margin-top: -10px">
            <div class="card-header">
                <h3>@lang('trans.users.fields.edit_user')</h3>
            </div>
            <div class="card-body">
                <form action="{{route('admin.users.update' , $user->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" placeholder="Email" id="email" class="form-control" value="{{old('email',$user->email)}}" >
                                  @error('email')
                                      <span class="text-danger">{{$message}}</span>
                                  @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                               ...
                               > Female</option>
                               <option value="company"                                @if ($user->gender == 'company')selected @endif
                                >Company</option>
                                </select>
                                  @error('gender')
                                      <span class="text-danger">{{$message}}</span>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <option value="{{$country->id}}" @if ($user->country_id === $country->id)selected
                                @endif>
                            {{$country->name}}
                            </option>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <option value="{{$state->id}}"
                                @if ($user->state_id === $state->id)selected
                                @endif>
                            {{$state->name}}
                            </option>
                            @endforeach
