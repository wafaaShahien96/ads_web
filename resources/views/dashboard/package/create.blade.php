        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.package.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-6">    
                    ...
                    <select id="package_type" name="package_type" class="form-control mb-2 js-example-basic-single" autofocus>
                        ...
                        <option value="basic">@lang('trans.basic')</option>
                        <option value="value">@lang('trans.value')</option>
                        <option value="plus">@lang('trans.plus')</option>
                    </select>
                    </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="total_ads" value="{{ old('total_ads') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="regular_ads" value="{{ old('regular_ads') }}">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="featured_ads" value="{{ old('featured_ads') }}">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="featured_ads_validity" value="{{ old('featured_ads_validity') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="package_validity" value="{{ old('package_validity') }}">
